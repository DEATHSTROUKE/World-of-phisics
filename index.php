...
<head>
    ...
    <title><?php echo "Мир физики" ?></title>
</head>
<body>
<header class="header">
    <div class="menu">
        <div class="container">
            <div class="header__top">
                ...
                <nav class="nav">
                    <input type="submit" class="btn__deactive" value="Вход">
                    <input type="submit" class="btn__active" value="Регистрация">
                </nav>
                <div class="hamburger">
    ...
    <div class="container">
        ...
        <div class="prepare">
            <div class="pre__text">
                ...
                <input type="submit" class="btn__active btn_blue" value="Вперед">
            </div>
    ...
    <div class="container">
        ...
        <div class="prepare">
            ...
            <div class="pre__text">
                ...
                <input type="submit" class="btn__active btn_blue" value="Посмотреть">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="prepare">
            <div class="pre__text">
                ...
                <input type="submit" class="btn__active btn_blue" value="Рейтинг">
            </div>
